...
@section('content')
    @if (Request::is('product/create'))
        <div class="container-fluid px-4">
            <h2 class="mt-3" style="margin-left: 16px">Tambah Data Barang</h2>
            ...
            <div>
                <div class="card-body">
                    <form class="form-product">
                        @csrf
                        <div class="mb-3">
                            <input type="text" class="form-control validation" name="nama" placeholder="Nama Barang"
                                autofocus required>
                        ...
                        <div class="mb-3">
                            <input type="number" class="form-control validation" name="diskon" placeholder="Diskon" required
                                value="0">
                            <span class="text-start text-danger" style="font-size: 13px; font-style: italic">Diskon
                                (%)</span>
                            <div class="invalid-feedback ediskon">
                            </div>
                        </div>
                        <div class="mb-3">
                            <input type="number" class="form-control validation" name="stok" placeholder="Jumlah Stok"
                                required>
    ...
    @else
        <div class="container-fluid px-4">
            <h2 class="mt-3" style="margin-left: 16px">Edit Data Barang</h2>
            <div>
                <div class="card-body">
                    <form action="{{ route('product.update', $product->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            <input type="text" class="form-control validation" name="nama" placeholder="Nama Barang"
                                autofocus required value="{{ $product->nama }}">
                            <div class="invalid-feedback enama">
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-2">
                            <select class="form-select validation" name="category_id" id="category_id"
                                ...
                                <option selected value="">Pilih kategori barang</option>
                                @foreach ($category as $p)
                                    <option value="{{ $p->id }}" {{ $p->id == true ? 'selected' : '' }}>
                                        {{ $p->jenis . ' - ' . $p->kategori }}</option>
                                @endforeach
                            </select>
                            <div class="invalid-feedback ecategory">
                            </div>
                        ...
                        <div class="mb-3">
                            <input type="number" class="form-control validation" name="hargabeli" placeholder="Harga Beli"
                                required value="{{ $product->harga_beli }}">
                            <div class="invalid-feedback ehargabeli">
                            </div>
                        </div>
                        <div class="mb-3">
                            <input type="number" class="form-control validation" name="hargajual1" placeholder="Harga Jual"
                                required value="{{ $product->harga_jual }}">
                            <div class="invalid-feedback ehargajual1">
                            </div>
                        </div>
                        <div class="mb-3">
                            <input type="number " class="form-control validation" name="hargajual2" id="hargajual2"
                                placeholder="Harga Jual Opsional" disabled value="{{ $product->harga_jual_opsi }}">
                            <div class="invalid-feedback ehargajual2">
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-primary updateProduct">Submit</button>
                    </form>
                </div>
            </div>
        </div>
